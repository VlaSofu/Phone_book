...
public:
    ...
    void setFirstName(const string firstName) {
        ...
        while (!flag) {
            try {
                ...
                regex pattern("^[A-Za-zА-Яа-я0-9\\s-]+[A-Za-zА-Яа-я]$");
    ...
    void setCity(const string newCity) {
        ...
        while (!flag) {
            try {
                ...
                regex pattern("^[а-яА-Яa-zA-Z][а-яА-Яa-zA-Z\\-\\s]*$");
    ...
    void setHouseNumber(const string newHouseNumber) {
        ...
        while (!flag) {
            try {
                ...
                regex pattern("^\\d+[-а-яА-Яa-zA-Z]?\\d*$");
    ...
    // Метод сериализации объекта в строку для записи в файл
    ...
    // Метод десериализации объекта из строки для вывода из файла
